  ...
  <body>
    ...
    <div class="content" align="center">
      <form method="POST" name="form1" onsubmit="loadVal();" enctype="multipart/form-data">    
        <div class="F1">
          <h1 align="center">Insert Room</h1>
          <div align="center" class="F2">
            <label id="L1"><i class="fas fa-bed"></i>&nbsp;&nbsp;Room Type Name:</label>
            <select name="roomtype" class="form-control" id="T1" style="font-family:Cambria;">
                <?php
                    $query="select * from roomtype";
                    $go_query=mysqli_query($connection,$query);
                    while($row=mysqli_fetch_array($go_query))
                    {
                        $rt_id=$row['roomtypeid'];
          ...
          <div align="center">
            ...
            <input type="text" name="price" id="T1" style="font-family:Cambria;" placeholder="Enter room price" require="required">
          </div>
