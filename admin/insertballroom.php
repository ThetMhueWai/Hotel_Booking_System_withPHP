  ...
  <body>
    ...
    <div class="content" align="center">
      <form method="POST" name="form1" onsubmit="loadVal();" enctype="multipart/form-data"> 
        <div class="F1">
          <h1 align="center">Insert Ballroom</h1>
          <div align="center">
            <label id="L1"><i class="fas fa-door-open"></i>&nbsp;&nbsp;Ballroom Name:</label>
            <input type="text" name="bname" id="T1" style="font-family:Cambria;" placeholder="Enter ballroom name" require="required">
          </div>

          <div align="center">
            <label id="L1"><i class="fas fa-dollar-sign"></i>&nbsp;&nbsp;Price:</label>
            <input type="text" name="price" id="T1" style="font-family:Cambria;" placeholder="Enter ballroom price" require="required">
          </div>
          
          <div align="center">
            <label id="L1"><i class="fas fa-users"></i>&nbsp;&nbsp;Limit:</label>
            <input type="text" name="limit" id="T1" style="font-family:Cambria;" placeholder="Enter limit person" require="required">
          </div>
          ...
          <div align="center" class="F2">
            ...
            <select name="roomtype" class="form-control" id="T2" style="font-family:Cambria">
                <?php
                    $query="select * from ballroomtype";
                    $go_query=mysqli_query($connection,$query);
                    while($row=mysqli_fetch_array($go_query))
                    {
                        $rt_id=$row['ballroomtypeid'];
                        $rt_name=$row['ballroomtypename'];
          ...
          <div align="center">
            ...
            <textarea name="deco2" id="T3" require="required"></textarea>
          </div> 
